...
my %augmented_src_of = (  # English pages that are split in Arabic (chapter intros, and chapter-like sections)
  ...
  # Ch5: Distributed-Git > Contributing-to-a-Project augmentation
    "_contributing_project" => "Distributed-Git-Contributing-to-a-Project",
    (map { $_ => s|^|Distributed-Git-Contributing-to-a-Project#|r }
      qw[ _commit_guidelines _private_team _private_managed_team _public_project _project_over_email summary-contrib ]),
  # Ch5: Distributed-Git > Maintaining-a-Project augmentation
    ...
    (map { $_ => s|^|Distributed-Git-Maintaining-a-Project#|r }
      qw[ _patches_from_email _checking_out_remotes _what_is_introduced ]),
    "maintaining-project-integrating" => "Distributed-Git-Maintaining-a-Project#_integrating_contributed_work",
    "maintaining-project-releasing" => "Distributed-Git-Maintaining-a-Project#_tagging_releases",
  #
...
my %exact_src_of = (
  ...
  "_first_time" => "Getting-Started-First-Time-Git-Setup",
  "_git_help" => "Getting-Started-Getting-Help",
  "summary-01" => "Getting-Started-Summary",
  # ch02
  "_getting_a_repo" => "Git-Basics-Getting-a-Git-Repository",
  "recording-changes" => "Git-Basics-Recording-Changes-to-the-Repository",
  "_viewing_history" => "Git-Basics-Viewing-the-Commit-History",
  "_undoing" => "Git-Basics-Undoing-Things",
  "_remote_repos" => "Git-Basics-Working-with-Remotes",
  "_git_tagging" => "Git-Basics-Tagging",
  "_git_aliases" => "Git-Basics-Git-Aliases",
  "summary-02" => "Git-Basics-Summary",
  # ch03
  "_git_branches_overview" => "Git-Branching-Branches-in-a-Nutshell",
  "basic-branching-merging" => "Git-Branching-Basic-Branching-and-Merging",
  "_branch_management" => "Git-Branching-Branch-Management",
  "branching-workflows" => "Git-Branching-Branching-Workflows",
  "_remote_branches" => "Git-Branching-Remote-Branches",
  "_rebasing" => "Git-Branching-Rebasing",
  "summary-03" => "Git-Branching-Summary",
  # ch04
  "protocols" => "Git-on-the-Server-The-Protocols",
  "_getting_git_on_a_server" => "Git-on-the-Server-Getting-Git-on-a-Server",
  "_generate_ssh_key" => "Git-on-the-Server-Generating-Your-SSH-Public-Key",
  "_setting_up_server" => "Git-on-the-Server-Setting-Up-the-Server",
  ...
  # "_contributing_project" => "Distributed-Git-Contributing-to-a-Project",  # NOTE: augmented
  ...
  "_maintaining_gh_project" => "GitHub-Maintaining-a-Project",
  "ch06-github_orgs" => "GitHub-Managing-an-organization",
  "github-scripting" => "GitHub-Scripting-GitHub",
  "summary-06" => "GitHub-Summary",
  # ch07
  "_revision_selection" => "Git-Tools-Revision-Selection",
  "_interactive_staging" => "Git-Tools-Interactive-Staging",
  "_git_stashing" => "Git-Tools-Stashing-and-Cleaning",
  "_signing" => "Git-Tools-Signing-Your-Work",
  "_searching" => "Git-Tools-Searching",
  "_rewriting_history" => "Git-Tools-Rewriting-History",
  "_git_reset" => "Git-Tools-Reset-Demystified",
  "_advanced_merging" => "Git-Tools-Advanced-Merging",
  "ref_rerere" => "Git-Tools-Rerere",
  "debugging-with-git" => "Git-Tools-Debugging-with-Git",
  "_git_submodules" => "Git-Tools-Submodules",
  "_bundling" => "Git-Tools-Bundling",
  "_replace" => "Git-Tools-Replace",
  "_credential_caching" => "Git-Tools-Credential-Storage",
  "summary-07" => "Git-Tools-Summary",
  # ch08
  "_git_config" => "Customizing-Git-Git-Configuration",
  "git-attributes" => "Customizing-Git-Git-Attributes",
  "_git_hooks" => "Customizing-Git-Git-Hooks",
  "_an_example_git_enforced_policy" => "Customizing-Git-An-Example-Git-Enforced-Policy",
  "summary-08" => "Customizing-Git-Summary",
  # ch09
  "git-as-client" => "Git-and-Other-Systems-Git-as-a-Client",
  "_migrating" => "Git-and-Other-Systems-Migrating-to-Git",
  "summary-09" => "Git-and-Other-Systems-Summary",
  # ch10
  "_plumbing_porcelain" => "Git-Internals-Plumbing-and-Porcelain",
  "_objects" => "Git-Internals-Git-Objects",
  "_git_refs" => "Git-Internals-Git-References",
  "packfiles" => "Git-Internals-Packfiles",
  "_refspec" => "Git-Internals-The-Refspec",
  ...
  "_git_powershell" => "Appendix-A:-Git-in-Other-Environments-Git-in-PowerShell",
